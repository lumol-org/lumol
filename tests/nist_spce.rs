...
mod cutoff_9 {
    ...
    #[test]
    fn nist1() {
        let path = "nist/configuration/spce_1.xyz";
    ...
    #[test]
    fn nist2() {
        let path = "nist/configuration/spce_2.xyz";
        let system = get_system(path, 9.0);
    ...
    #[test]
    fn nist3() {
        let path = "nist/configuration/spce_3.xyz";
        let system = get_system(path, 9.0);
    ...
    #[test]
    fn nist4() {
        let path = "nist/configuration/spce_4.xyz";
        let system = get_system(path, 9.0);
